...
export const INITIAL_PROVIDERS: Provider[] = [
  {
    id: '1',
    name: 'أريز',
    specialty: Specialty.MSK,
    days: [0],
    dailyCapacity: 4,
    isNewPatientProvider: false,
    newPatientQuota: 0,
    slug: 'ariz',
  }, // Sunday
  {
    id: '2',
    name: 'عبدالكريم ال عجيم',
    specialty: Specialty.MSK,
    days: [1],
    dailyCapacity: 4,
    isNewPatientProvider: false,
    newPatientQuota: 0,
    slug: 'abdulkarim_al_ajim',
  }, // Monday
  {
    id: '3',
    name: 'محمد الناوي',
    ...
    isNewPatientProvider: false,
    newPatientQuota: 0,
    slug: 'mohammed_alnavi',
  }, // Tuesday
  {
    id: '4',
    name: 'سعد القحطاني',
    specialty: Specialty.Neuro,
    days: [3],
    dailyCapacity: 4,
    isNewPatientProvider: false,
    newPatientQuota: 0,
  ...
  }, // Wednesday
  {
    id: '5',
    name: 'محمد يوسف',
    specialty: Specialty.PT_Service,
    days: [0, 1, 2, 3],
    dailyCapacity: 2,
    isNewPatientProvider: true,
    newPatientQuota: 2,
    slug: 'mohamed_youssef',
  },
  {
    id: '6',
    name: 'خالد العماري',
