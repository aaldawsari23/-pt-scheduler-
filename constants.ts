...
// FIX: Updated HEP_CONTENT to match the HepContent interface: added navTitle, tipsTitle, and tips,
// wrapped exercise descriptions in an array to match `string[]` type, and removed the incorrect `disclaimer` property.
...
// FIX: Added HEP_DISCLAIMER export to resolve import error in HepModal.
